...
import com.xx.base.org.util.BaseAdaptScreenUtils;
import com.xx.base.org.util.BaseScreenUtils;

/**
 * @author Lixingxing
 */
public abstract class ProBaseViewModelActivity extends DataBindingActivity {
...
//        getLifecycle().addObserver(NetworkStateManager.getInstance());
    ...
    public Resources getResources() {
        if (BaseScreenUtils.isPortrait()) {
            return BaseAdaptScreenUtils.adaptWidth(super.getResources(), 360);
        } else {
            return BaseAdaptScreenUtils.adaptHeight(super.getResources(), 640);
        }
    }
