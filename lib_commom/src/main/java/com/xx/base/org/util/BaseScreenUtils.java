 ...
 * </pre>
 */
public final class BaseScreenUtils {

    private BaseScreenUtils() {
    ...
    public static boolean isLandscape() {
        return BaseUtils.getContext().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) BaseUtils.getContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static int getSleepDuration() {
        try {
            return Settings.System.getInt(
                    BaseUtils.getContext().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (BaseUtils.getContext().getResources().getConfiguration().screenLayout
