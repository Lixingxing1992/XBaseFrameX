...
public final class BaseAdaptScreenUtils {
    ...
    public static int pt2Px(float ptValue) {
        DisplayMetrics metrics = BaseUtils.getContext().getResources().getDisplayMetrics();
    ...
    private static void setAppDmXdpi(final float xdpi) {
        BaseUtils.getContext().getResources().getDisplayMetrics().xdpi = xdpi;
    }
