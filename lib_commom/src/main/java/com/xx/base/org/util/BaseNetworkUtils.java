...
public final class BaseNetworkUtils {
    ...
    public static void openWirelessSettings() {
        BaseUtils.getContext().startActivity(
    ...
    public static boolean isAvailableByPing(String ip) {
        ...
        BaseShellUtils.CommandResult result = BaseShellUtils.execCmd(String.format("ping -c 1 %s", ip), false);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) BaseUtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) {
                return false;
            }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseUtils.getContext().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) BaseUtils.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseUtils.getContext().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
